...
class BamlAsyncClient:
    ...
    async def ClassifyFaithfulnessErrors(self, claim: str,source_content: str,
        baml_options: BamlCallOptions = {},
    ) -> typing.List["types.FaithfulnessError"]:
        result = await self.__options.merge_options(baml_options).call_function_async(function_name="ClassifyFaithfulnessErrors", args={
...
class BamlStreamClient:
    ...
    def ClassifyFaithfulnessErrors(self, claim: str,source_content: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[typing.List["stream_types.FaithfulnessError"], typing.List["types.FaithfulnessError"]]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="ClassifyFaithfulnessErrors", args={
            "claim": claim,"source_content": source_content,
        })
        return baml_py.BamlStream[typing.List["stream_types.FaithfulnessError"], typing.List["types.FaithfulnessError"]](
          result,
...
class BamlHttpRequestClient:
    ...
    async def ClassifyFaithfulnessErrors(self, claim: str,source_content: str,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="ClassifyFaithfulnessErrors", args={
            "claim": claim,"source_content": source_content,
        }, mode="request")
        return result
